package org.jhipster.blogv4.web.rest;
...
import org.jhipster.blogv4.IntegrationTest;
import org.jhipster.blogv4.domain.Car;
import org.jhipster.blogv4.domain.Document;
import org.jhipster.blogv4.repository.DocumentRepository;
...
class DocumentResourceIT {
    ...
    private static final Long DEFAULT_SIZES = 1L;
    private static final Long UPDATED_SIZES = 2L;
    ...
    public static Document createEntity(EntityManager em) {
        Document document = new Document().title(DEFAULT_TITLE).sizes(DEFAULT_SIZES).mimeType(DEFAULT_MIME_TYPE);
        // Add required entity
        Car car;
    ...
    public static Document createUpdatedEntity(EntityManager em) {
        Document document = new Document().title(UPDATED_TITLE).sizes(UPDATED_SIZES).mimeType(UPDATED_MIME_TYPE);
        // Add required entity
        Car car;
        if (TestUtil.findAll(em, Car.class).isEmpty()) {
    ...
    void createDocument() throws Exception {
        ...
        assertThat(testDocument.getSizes()).isEqualTo(DEFAULT_SIZES);
    ...
    @Test
    @Transactional
    void checkSizesIsRequired() throws Exception {
        int databaseSizeBeforeTest = documentRepository.findAll().size();
        // set the field null
        document.setSizes(null);
    ...
    void getAllDocuments() throws Exception {
        ...
        restDocumentMockMvc
            ...
            .andExpect(jsonPath("$.[*].sizes").value(hasItem(DEFAULT_SIZES.intValue())))
    ...
    void getDocument() throws Exception {
        ...
        restDocumentMockMvc
            ...
            .andExpect(jsonPath("$.sizes").value(DEFAULT_SIZES.intValue()))
    ...
    void putExistingDocument() throws Exception {
        ...
        updatedDocument.title(UPDATED_TITLE).sizes(UPDATED_SIZES).mimeType(UPDATED_MIME_TYPE);
        ...
        assertThat(testDocument.getSizes()).isEqualTo(UPDATED_SIZES);
    ...
    void partialUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.title(UPDATED_TITLE).sizes(UPDATED_SIZES);
    ...
    void fullUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.title(UPDATED_TITLE).sizes(UPDATED_SIZES).mimeType(UPDATED_MIME_TYPE);
